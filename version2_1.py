...
midis = []
for file in glob.glob('final_fantasy_8/ff8waltzthemoon.mid'):
    try:
...
# Generate music!
melody = stream.Stream([instrument.Viola()])
melody2 = stream.Stream([instrument.Oboe()])
harmony = stream.Stream([instrument.Vocalist()])
# Start from C
ni = NOTE2IDX['D']
n2i = NOTE2IDX['D']
ci = CHORD2IDX['D major']
